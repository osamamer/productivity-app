<#--
  Based on Keycloak 26.5.2's keycloak.v2 login template.
  Keep this override in sync when the pinned Keycloak image is upgraded.
  The default favicon link is intentionally omitted for the Claritard login.
-->
...
<#if properties.appFaviconUrl?has_content>
<link rel="icon" type="image/png" href="${properties.appFaviconUrl}" />
</#if>
...
<path d="M31.3 192h257.3c17.1 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 14.2 192 31.3 192z"></path>
</svg>
</span>
</span>
</div>
